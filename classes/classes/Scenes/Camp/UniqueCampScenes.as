...
public function droppingToZeroSatietyAsGargoyle():void
{
	...
	if (player.hasPerk(PerkLib.GargoylePure)) {
		...
		if (player.hasVagina()) {
			outputText("You rush into the mountain, starved for energy, and seduce the first minotaur you can find, putting your drooling pussy on display. The minotaur, used to having to fight for a hole to fuck, does not complain and lies down for you to take him in.  Your eyes zero in as a dollop of pre escapes his ribbed horse-like member, locating the source of the smell.\n\n");
			//Too small
			if(player.vaginalCapacity() < monster.cockArea(0)) {
				outputText("Your restraint evaporates as you lower yourself, your aching " + vaginaDescript(0) + " desperate for contact.  Your thighs quiver as you touch his wobbling column of maleness, the slick pre-cum soaking into your engorged clit and filling it with tingling warmth.  Oblivious to the apparent size difference your body pushes downwards, and your knees give out, forcing his flared head against your " + vaginaDescript(0) + " roughly.  The need to be speared on the beast's meat is overwhelming, urged on by the constantly leaking pre-cum currently pumping into your love-canal.  With strength born of unnatural lust, you grip his flanks and drive yourself downwards, feeling yourself stretch painfully as you take in his length.");
			}
			//Good match
			if(player.vaginalCapacity() >= monster.cockArea(0) && player.vaginalCapacity() < monster.cockArea(0) * 1.5) {
				outputText("Your restraint evaporates as you lower yourself, your aching " + vaginaDescript(0) + " desperate for contact.  Your thighs quiver as you touch his wobbling column of maleness, the slick pre-cum soaking into your engorged clit and filling it with tingling warmth.  You push downwards eagerly, happily noting that you should be able to accommodate his length and girth.  The overly wide head slips inside, easily lubricated with his copious fluids, and musky pre-spunk lubricates your passage with its intoxicating sensation.  With deliberate slowness you sink down along his shaft; shuddering once, twice, then three times as you pass each of the thick fleshy rings along his length.  Eventually, you bottom on him.");
			}
			//Bigger than he is
			if(player.vaginalCapacity() >= monster.cockArea(0) *1.5) {
				outputText("Your restraint evaporates as you lower yourself, your aching " + vaginaDescript(0) + " desperate for contact.  Your thighs quiver as you touch his wobbling column of maleness, the slick pre-cum soaking into your engorged clit and filling it with tingling warmth.  With a lusty giggle you slip his head inside your " + vaginaDescript(0) + ", allowing him to drool his musky pre-seed deep inside your wide love-canal.  Sinking down slowly, you easily encompass all of his equine-like member, and enjoy the feeling of his three thick cock-ridges as they slip through your lips.  Eventually you take all of him, wishing he was just a little bit bigger...");
			}
			//Resume sexings, p2
			outputText("\n\nAt last you feel the minotaur's meaty hands grab you by the " + hipDescript() + ", forcefully grinding you up and down his length like a cheap sex-toy.");
			//Size variants
			//Too small
			...
			//Just right
			if(player.vaginalCapacity() >= monster.cockArea(0) && player.vaginalCapacity() * 1.5 < monster.cockArea(0)) outputText("Every stroke of his [monster cockshort] deposits a bit more of his wondrous pre-seed into your body, spreading a relaxing warmth throughout your groin.");
			//Too big
			...
			outputText("You begin to fondle your cock as you walk towards the unsuspecting goblin girl, taking in the sight of her perfectly round cheeks as they jiggle against her hurried movements, her soft thighs clenched against the eager hand between them.  Bending down, you quickly grab the goblin's ample hips which causes the girl to squeak in surprise as she turns around to catch the sight of your erect length.\n\n");
			outputText("\"<i>W-woah!  Hey stud, whaddya think you're doing back there?</i>\" she yelps, more surprised than scared at your sudden appearance.  Instead of answering, you decide to grab your cock and slap it against the bare flesh of her ass while your victim anxiously awaits your next move.  You take your time massaging the goblin's slutty ass with your bare hands before sliding your " + cockDescript(x) + " in between her soft cheeks.  ");
			outputText("Your horny victim appears impatient and attempts to grind against you as she spreads her moist lips open, enthusiastic that she's found someone willing to mate with her.  You slap her ass firmly as you quicken your thrusting - seconds before finally plunging your dick inside of the panting whore, pushing her forwards violently as you enter her tight snatch.\n\n");
...
public function transformationIntoDemiHollow():void {
	...
	outputText("Your awareness dims, your body feels distant. A strange sensation hangs around you like smoke and ash circling to fire. Your [chest] aches, needles of pain stab at you heart, and breath throttled in your chest. You look down and see it: a chain, spectral links embedded in where your heart should be. It dangles downwards and fades into nothingness.\n\n");
...
private function impTomeGiveIn():void {
	...
	outputText(".[pg]You feel your orgasm coming through like a tidal wave, breaching through the barriers of the rational thoughts you erected in your mind and turning everything to mush. You cum out your essence in the form of purple fluids onto the pages ,the letter of your name now forming as the newly printed ink dries up. As if on cue, your body is suddenly pulled in further! You're being dragged right into the pages! First your feet, then your legs, and before you know it you're in up to your torso. The tome is eating you up! You try a final time to pull yourself out of the book as a third orgasm rocks you, causing you to release your hold and be dragged right into the tome![pg]");
