...
public function impTomeScene():void {
	clearOutput();
	outputText("You moan as you spontaneously cum. Your impish body has absorbed so much energy from the many victims you've violated that it’s ready to be expunged. [pg]");
...
private function impTomeGiveIn():void {
	...
	outputText(".[pg]You feel your orgasm coming through like a tidal wave, breaching through the barriers of rational thought you erected in your mind and turning everything to mush. You cum out your essence in the form of purple fluids onto the pages, the letter of your name now forming as the newly scribed ink dries up. As if on cue, your body is suddenly pulled in further! You're being dragged right into the pages! First your feet, then your legs, and before you know it you're in up to your torso. The tome is eating you up! You try a final time to pull yourself out of the book as a third orgasm rocks you, causing you to release your hold and be dragged right into the tome![pg]");
	outputText("Surrounded by darkness, you have no idea where you are. You try moving, but you are firmly stuck in a caged prison, of which the only exit seems to be currently closed. You don't even have enough space to masturbate, talk about inconvenience! Just as you're about to fall asleep you're suddenly pulled down by your hair into a very tight fleshy passage.[pg]");
	...
	outputText("Yet the idea of taking over the world by storm as the strongest imp gives you chills of pleasure;");
