...
public function playwithyourplantdaughters():void
{
	...
	outputText("Your daughters all cheer up as they pick up the toys and rush to the rivers to fill them up. Soon you’re all splashing each other. The experience is refreshing and soothing. You never thought you would appreciate having children this much. Perhaps parenting comes included in the whole \"being a child of a fertility goddess\" deal you ponder.This is before being splashed in the face by one of your daughters, breaking you out of your reverie, dragging you back into the game.\n\n");
	doNext(camp.returnToCampUseOneHour);
}
